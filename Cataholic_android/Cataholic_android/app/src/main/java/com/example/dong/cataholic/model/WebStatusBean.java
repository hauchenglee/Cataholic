...
@Entity(foreignKeys = @ForeignKey(entity = WebStatusBean.class, parentColumns = "memberKey", childColumns = "memberKey"),indices = @Index(value={"memberKey"},unique = true))
public class WebStatusBean implements Serializable {
    ...
    public WebStatusBean() {
    }

    public WebStatusBean(Integer satausId, Long beginTime, Long income, Long saveTime, Boolean smoke, Integer pressureStatus, Integer generateSpeed, Integer money, Integer effectTime, List<SmallCat> smallCats, List<SmallCat> nullSmallCats, Long endTime, Integer memberKey) {
